namespace TrinityCore.GameClient.Net.Lib.World.Enums
{
    public enum SplineFlags : uint
    {
        ...
        Enter_Cycle =
            0x00100000, // Everytimes appears with cyclic flag in monster move packet, erases first spline vertex after first cycle done
        ...
        Mask_Unused = No_Spline | Enter_Cycle | Frozen | Unknown7 | Unknown8 | Unknown10 | Unknown11 | Unknown12 |
                      Unknown13
    }
}
