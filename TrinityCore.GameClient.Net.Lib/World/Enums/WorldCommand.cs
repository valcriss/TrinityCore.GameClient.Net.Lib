namespace TrinityCore.GameClient.Net.Lib.World.Enums
{
    internal enum WorldCommand : uint
    {
        ...
        ///     ulong
        ///     int
        ///     if ( chatType == MonsterSay (12) || chatType == MonsterParty (13) || chatType == MonsterYell (14) || chatType ==
        ///     MonsterWhisper (15)
        ///     || chatType == MonsterEmote (16) || chatType == RaidBossWhisper (41) || || chatType == RaidBossEmote (42) ||
        ///     chatType == BN (47) )
        ///     {
        ///     int str1Len
